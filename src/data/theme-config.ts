...
export const themeConfig: Record<string, ThemeConfig> = {
  cp: {
    ...
    companies: [
      ...
      { id: 'tech-industries', name: 'Tech Industries', gradientColor: '#4C92D9' },
      { id: 'global-services', name: 'Global Services', gradientColor: '#30659F' }
    ]
  },
  vp: {
    name: 'VP',
  ...
  maconomy: {
    ...
    components: [],
    companies: [
      { id: 'consulting-firm', name: 'Consulting Firm', gradientColor: '#804A98' }
    ]
  }
};
