...
5. If the source component is **new to the design system** (not just a new pattern doc for an existing export), remind them to complete the **harmony** [ADD_COMPONENT_CHECKLIST.md](../harmony/reference/ADD_COMPONENT_CHECKLIST.md) and run `npm run validate:catalog`.
