...
const STATUS_ROUTE_KINDS = new Set(['foundation', 'component', 'shell', 'theme']);

const FOUNDATION_SLUG_TO_SCOPE = {
  colors: 'Colors',
...
/** URL segment → conversion.manifest element key (aligned with shadcn demoScope). */
const COMPONENT_SLUG_TO_SCOPE = {
  accordion: 'Accordion',
  alerts: 'Alert',
  avatar: 'Avatar',
  badges: 'Badge',
...
export function shouldShowConversionStatus(pathname) {
