/* Generated by scripts/generate-styles.mjs from src/styles/notification-badge.css — do not edit. */
export const notificationBadgeCss = `/**
 * Notification Badge — Shadow DOM sheet only (CE).
 * Extracted from reference src/styles/components.css + host wrappers.
 */
...
:host([data-empty]) {
  /* standalone badge without wrapped target */
}

.notification-badge {
  /* when wrapping, position absolute top-end by default */
}

:host(:not([data-empty])) .notification-badge {
  position: absolute;
  top: 0;
  right: 0;
...
/* Dot type - perfectly circular */
.notification-badge--dot {
  aspect-ratio: 1 / 1;
  border-radius: 50%;
}

/* Number and overflow types */
...
.notification-badge--sm.notification-badge--overflow.notification-badge--border {
  ...
  min-width: var(--badge-min-width-sm);
...
.notification-badge--md.notification-badge--overflow.notification-badge--border {
  ...
  min-width: var(--badge-min-width-md);
  padding: var(--space-1) var(--space-1-5);
  border: var(--border-width-standard) solid var(--text-inverse, #ffffff);
  box-sizing: border-box;
}
...
.notification-badge--lg.notification-badge--overflow.notification-badge--border {
  ...
  min-width: var(--badge-min-width-lg);
...
.notification-badge--error {
  background-color: var(--notification-badge-error);
}
...
@media (forced-colors: active) {
  .notification-badge {
    ...
    color: Canvas;
    border: var(--border-width-standard) solid Canvas;
